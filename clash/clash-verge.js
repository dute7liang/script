...
const domesticNameservers = [
  ...
  const dnsConfig = {
    ...
    "nameserver-policy": {
    //   "aa.com": ["10.204.224.254", "10.204.130.6"], 
  ...
  const rules = [
    ...
    //"IP-CIDR,IP/32,🔗 全局直连,no-resolve", 
    "DOMAIN-SUFFIX,statchannel.top,🔗 全局直连",
  ...
  const proxyGroupsConfig = [
      ...
      },
      {
        ...
        "tolerance": 50,
        "include-all": true,
        "filter": "(?i)美|us|usa|unitedstates|united states|america|洛杉矶|硅谷|圣何塞|西雅图|纽约",
      ...
      },
      {
        ...
        "tolerance": 50,
        "include-all": true,
        "filter": "(?i)新加坡|sg|singapore|狮城|坡|sin",
      ...
      },
      {
        ...
        "name": "🌍 国外媒体",
        "type": "select",
        "proxies": ["🔰 模式选择", "🇭🇰 香港节点", "🇺🇸 美国节点", "🇸🇬 新加坡节点", "⚙️ 节点选择", "🕊️ 落地节点", "🔗 全局直连"],
        "include-all": true,
      ...
      },
      {
        ...
        "name": "📺 Bilibili",
        "type": "select",
        "proxies": ["🔗 全局直连", "🔰 模式选择", "🇭🇰 香港节点", "🇺🇸 美国节点", "🇸🇬 新加坡节点", "⚙️ 节点选择", "🕊️ 落地节点"],
        "include-all": true,
      ...
      },
      {
        ...
        "name": "💬 ChatGPT",
        "type": "select",
        "proxies": ["🔰 模式选择", "🇺🇸 美国节点", "🇸🇬 新加坡节点", "⚙️ 节点选择", "🕊️ 落地节点", "🔗 全局直连"],
        "include-all": true,
      ...
      },
      {
        ...
        "type": "select",
        "include-all": true,
        "proxies": ["🔗 全局直连", "🔰 模式选择", "🇭🇰 香港节点", "🇺🇸 美国节点", "🇸🇬 新加坡节点", "⚙️ 节点选择"],
        "icon": "https://fastly.jsdelivr.net/gh/clash-verge-rev/clash-verge-rev.github.io@main/docs/assets/icons/unknown.svg"
      },
      {
        ...groupBaseOption,
